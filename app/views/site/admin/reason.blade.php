...
<div class="page-header">
    <table id="reasonTable" class="table table-striped table-bordered" cellspacing="0" width="100%">
        <thead>
        <tr>
            <th>Reasons</th>
            <th></th>
        ...
        <tr>
            <td>{{Form::text('name', $reason->description, array('class'=>'form-control', 'style'=>'width:100%','id'=>$reason->id))}}</td>
            <td><a href="#" data-toggle="modal" data-target="#modalReason" data-practice="{{$practice_id}}" data-reason="{{$reason->id}}">Delete</a> </td>
        </tr>
        @endforeach
...
<button class="btn btn-success" id="save-reason">
    Save All
</button>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="myModalLabel">Reason not scheduled delete confirmation</h4>
            </div>
